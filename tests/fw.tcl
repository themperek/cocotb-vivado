...
# Target the top BD explicitly: on Vivado 2025.1 a filter on all "Block
# Designs" also returns SmartConnect's nested sub-BD, which make_wrapper
# rejects ("can only be generated by its parent sub-design").
set wrapper_file [make_wrapper -files [get_files fw.bd] -top -import]
